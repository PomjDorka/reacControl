...
function getEnergyR()
    ...
    for i = 0, amountReactors, 1 do
        ...
        cap = cap + reactors[i]:capacity()
    end

    return math.floor(en / cap * 100)
end
...
function displayDataAuto()
    ...
    controlMonitor.write(_G.language:getText("rfProduction") .. input.formatNumberComma(math.floor(rfGen)) .. " FE/t      ")
    ...
    controlMonitor.write(_G.language:getText("wordEfficiency")..": " .. input.formatNumberComma(fuelEfficiency2) .. " FE/mb    ")
